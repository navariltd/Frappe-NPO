...
frappe.ui.form.on("Donation", {
	...
	update_project_options(frm) {
		frappe.call({
			method: "frappe_npo.non_profit.doctype.donation.donation.project_filter_by_donor",
	...
	make_payment_entry: function (frm) {
		return frappe.call({
			method: "frappe_npo.non_profit.custom_doctype.payment_entry.get_donation_payment_entry",
			args: {
				dt: frm.doc.doctype,
				dn: frm.doc.name,
			},
