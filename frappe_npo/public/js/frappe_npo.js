frappe.provide("frappe_npo.utils");
...
frappe_npo.utils.handle_state_field = (frm) => {
...
frappe_npo.utils.handle_district_field = (frm) => {
...
frappe_npo.utils.handle_zone_field = (frm) => {
...
frappe_npo.utils.handle_ward_field = (frm) => {
	if (frm.doc.ward) {
...
frappe_npo.utils.set_query_for_district = set_query_for_district;
frappe_npo.utils.set_query_for_zone = set_query_for_zone;
frappe_npo.utils.set_query_for_ward = set_query_for_ward;
